...
class Project(models.Model):
    ...
    file = models.FileField(upload_to='portfolio_files/', verbose_name='Файли', blank=True, null=True)
    link = models.URLField(verbose_name='Посилання', blank=True, null=True)
